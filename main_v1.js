document.addEventListener('DOMContentLoaded', () => {
        ...
        xhr.onload = async () => {
            try {
                ...
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    // --- FIX #1: This line is now UNCOMMENTED ---
                    // This will fetch the new credit count from the server.
    ...
    const resetForNewConversion = () => {
        ...
        // --- FIX #2: This line is ADDED ---
        // This clears the old "You have X conversions" message, preventing confusion.
        licenseStatus.innerHTML = '';
        // --- END OF FIX #2 ---
