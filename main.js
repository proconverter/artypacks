...
/* --- Get License Link (Revised for Hero Section) --- */
.get-license-link {
    font-size: 18px; /* Larger font size for better visibility */
    color: #52525b;
    margin-top: 10px; /* Adds space below the tagline */
}
.get-license-link a {
    color: #007bff;
...
.license-status-message.checking,
.license-status-message.valid { 
    color: #16a34a; 
}
